...
In your jupyter notebook, re-run the corresponding notebook of "GAFSE-MO/G_ADMET_{M,T}_{C}_{Task name}/G_ADMET_{M,T}_{C}_{Task name}.ipynb" to reproduce the training process of GAFSE-MO on molecular property. For example:
```
